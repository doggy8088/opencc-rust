...
pub const HK_VARIANTS_REV_PHRASES: &str = "\
一口吃個 一口喫個
一口吃成 一口喫成
一家三口 一家三口
一家五口 一家五口
...
pub const JP_SHINJITAI_CHARACTERS: &str = "\
両 兩
弁 辨
欠 缺
糸 絲
...
pub const JP_SHINJITAI_PHRASES: &str = "\
一獲千金 一攫千金
丁寧 叮嚀
丁重 鄭重
三差路 三叉路
...
pub const TW_PHRASES_CUSTOM: &str = "\
一觸即髮	一觸即發
千鈞一髮	千鈞一髮
蓄勢待髮	蓄勢待發
百髮百中	百發百中
...
pub const TW_PHRASES_CUSTOM_REV: &str = "\
一觸即發	一觸即髮
千鈞一髮	千鈞一髮
蓄勢待發	蓄勢待髮
百發百中	百髮百中
...
pub const TW_PHRASES_OTHER: &str = "\
元音 母音
冰棍 冰棒
出租車 計程車
咖喱 咖哩
...
pub const TW_VARIANTS_REV_PHRASES: &str = "\
一口吃個 一口喫個
一口吃成 一口喫成
一家三口 一家三口
一家五口 一家五口
